...
define('UC_KEY', '9b58DQIIrlnzbXXyLgxPYiIbcnUjk3dvtl1MgH0');
define('UC_API', 'http://www.discuzx.com/upload/uc_server');
...
define('UC_API', 'http://www.discuzx.com/upload/uc_server');	// UCenter 的 URL 地址, 在调用头像时依赖此常量
